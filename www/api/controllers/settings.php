 ...
 * @response {"name": "AudioFormat", "description": "Audio Output Format", "tip": "The Audio Format generated by the decoder ", "level": 1, "restart": 2, "default": 0, "type": "select", "options": {"Default": 0, "MP3": 1, "Ogg": 2, "Flac": 3}}
 */
function GetSetting()
{
    global $settings;
 ...
 * @response {"settingGroups": {"BBBLeds": {"description": "BeagleBone LEDs", "platforms": ["BeagleBone Black"], "settings": ["BBBLeds0", "BBBLeds1", "BBBLeds2", "BBBLeds3", "BBBLedPWR"]}}, "settings": {"alwaysTransmit": {}}}
 */
 ...
 *
 * @route GET /api/time
 * @response {"time": "Tue Apr 02 08:06:34 EDT 2019"}
 */
function GetTime()
{
    $result = array();
